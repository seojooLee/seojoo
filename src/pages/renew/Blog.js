  ...
  const intro = useRef([
    {
      ...
      companyNm: "라온시큐어",
      team: "사원",
      companyDetail: "블록체인 기반 보안 솔루션을 전문으로 하는 회사",
      work: "웹개발자(F/E)",
    },
    {
      id: "sqisoft",
      dueDate: "2019.09 ~ 2022.10.28",
      startDt: "2019.09",
      endDt: "2022.10",
      companyNm: "에스큐아이소프트",
      team: "사원",
  ...
  const workDetail = useRef([
    {
      ...
      data: [
        {
          title: "백오피스 프론트엔드(관리자용, 고객사용) 개발",
          date: "2023.05 ~ current",
          impTxt: `블록체인 DID 기반의 신원 및 자격 통합 Sass 신규 플랫폼`,
          stack: ["REACT"],
          result: "최상위 관리자, 고객사용 백오피스 개발 및 배포",
          detailWork: [
            "신규 서비스 백오피스 초기부터 개발 참여 및 개발환경 설정",
            "공용 컴포넌트 Styled-Components 사용하여 컴포넌트 설계",
            "react i8n 사용하여 백오피스 다국어 구조로 변환 작업",
          ],
        },
        {
          title: "목표 서비스 개발 (OKR)",
              ...
              return (
                <Row>
                  <td>
                    {item.dueDate +
                      "(" +
                      dayjs(dayjs(item.endDt)).diff(item.startDt, "year") +
                      "년)"}
                  </td>
